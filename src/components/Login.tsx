    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="glass-card max-w-md w-full p-8 rounded-[1rem] border border-outline-variant/10">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-on-surface-variant font-bold uppercase tracking-widest mt-2">Onyx Dashboard Login</p>
        </div>
        ...
        <div className="mt-6 text-center text-xs text-on-surface-variant">
          Need access? <button onClick={() => navigate('/register')} className="text-primary hover:underline font-bold uppercase tracking-widest">Register</button>
        </div>
      </div>
    </div>
  );
